...
int main(void) {
    /* ---- eth: 14-byte header + EtherType ---- */
    {
        uint8_t ipv4_frame[34] = {
            ...
            0,    0,    192,  168,  1,    10,   93, 184, 216, 34,
        };
        write_file("eth/ipv4_frame.bin", ipv4_frame, sizeof(ipv4_frame));

        uint8_t vlan_frame[38] = {
            0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0xaa, 0xbb, 0xcc, 0xdd,
            0xee, 0xff, 0x81, 0x00, 0x00, 0x64, /* VLAN tag, VID=100 */
    ...
    /* ---- ip: 20-byte IPv4 header, and one with a 4-byte options word ---- */
    {
        ...
        uint8_t with_options[24] = {
            0x46, 0x00, 0x00, 0x2c, 0xab, 0x12, 0x00, 0x00, 0x40, 0x06, 0xd8, 0x30, 192,
            168,  1,    10,   93,   184,  216,  34,   0x01, 0x01, 0x01, 0x00, /* NOP NOP NOP EOL
                                                                                 padding as fake
                                                                                 options */
        };
    ...
    /* ---- ipv6: 40-byte header ---- */
    {
        uint8_t hdr[40] = {
            ...
            0x00,
            0x00,
            0x00, /* version=6, traffic class=0, flow=0 */
            0x00,
